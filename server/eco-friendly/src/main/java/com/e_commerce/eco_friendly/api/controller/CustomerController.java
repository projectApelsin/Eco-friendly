...
public class CustomerController {
    ...
    @PostMapping("/addProductInfoToCustomer")
    public ResponseEntity<?> addProductInfoToCustomer(HttpServletRequest request, @RequestBody ProductInfoDTO productInfoDTO){
        customerService.productInfoToCustomer(customerService.getCustomerIdFromRequest(request), productInfoDTO);
